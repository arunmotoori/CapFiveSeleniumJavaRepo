...
public class RegisterPage {
	...
	private WebElement accountNotCreatedWarningMessage;
	...
	public void selectAgreeCheckBoxField() {
	...
	public boolean isAccountNotWarningMessageIsDisplayed() {
		
		return accountNotCreatedWarningMessage.isDisplayed();
	}
